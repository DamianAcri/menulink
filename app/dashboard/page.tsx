  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const categoryIds = (categoriesResponse?.data || []).map((c: any) => c.id);
        const menuItemsResponse = categoryIds.length > 0 ? 
          await supabase
            .from('menu_items')
            .select('id')
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
        ...
        <div className="mt-4 md:mt-0">
          ...
          >
            Ver mi página <span aria-hidden="true" className="ml-2">→</span>
          </Link>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        <div className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <svg className="h-6 w-6 text-gray-400 dark:text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="bg-gray-50 dark:bg-gray-700 px-5 py-3">
            <div className="text-sm">
              <Link href="/dashboard/stats" className="font-medium text-blue-600 dark:text-blue-400 hover:text-blue-500">
        ...
        <div className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
          ...
          <div className="bg-gray-50 dark:bg-gray-700 px-5 py-3">
            <div className="text-sm">
              <Link href="/dashboard/menu" className="font-medium text-blue-600 dark:text-blue-400 hover:text-blue-500">
                Administrar menú
              </Link>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd>
                    <div className="text-lg font-medium text-gray-900 dark:text-white">
                      {loading ? "..." : restaurant?.subscription_tier === 'premium' ? 'Premium' : (restaurant?.subscription_tier === 'pro' ? 'Pro' : 'Básico')}
                    </div>
                  </dd>
                </dl>
              </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 px-5 py-3">
            <div className="text-sm">
              <Link href="/dashboard/settings" className="font-medium text-blue-600 dark:text-blue-400 hover:text-blue-500">
          ...
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="mt-5 border border-gray-200 dark:border-gray-700 rounded-lg p-4 bg-gray-50 dark:bg-gray-700">
              ...
              <div className="mt-4 text-center">
                ...
                >
                  Abrir en nueva pestaña <span aria-hidden="true" className="ml-2">→</span>
                </Link>
              </div>
            </div>
          </div>
      ...
      <div className="bg-white dark:bg-gray-800 shadow sm:rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          ...
          <div className="mt-2 max-w-xl text-sm text-gray-500 dark:text-gray-400">
            <p>
              Para comenzar, necesitamos un poco de información sobre tu negocio.
              Esto nos permitirá crear tu página personalizada de menú.
            </p>
          </div>
          <form className="mt-5 space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                Esta será la URL donde tus clientes podrán ver tu menú. Solo letras, números y guiones.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                Una breve descripción de tu negocio que aparecerá en tu página de menú.
              </p>
            </div>
